 ...
 * @author Admin
 */
@WebServlet(name = "updatevexe", urlPatterns = {"/updatevexe"})
public class updatevexe extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        vexeDAO vdao = new vexeDAO();
        Vexe v = vdao.getVexeByID(vexeid);
        request.setAttribute("vexe", v);
        request.setAttribute("listV", list);
        request.getRequestDispatcher("updatevexe.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.updateVeXe(vexeid, chuyenxeid, numberofseat, thanhtoan);

 ...
 * @author Admin
 */
@WebServlet(name = "createchuyenxe", urlPatterns = {"/createchuyenxe"})
public class createchuyenxe extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.insertChuyenxe(chuyenxename, timestart, tuyenxeid, xeid, userid);
